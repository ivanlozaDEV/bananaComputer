  ...
  const handleConfirmTransfer = async () => {
    ...
    try {
      ...
      const whatsappUrl = getWhatsAppUrl(
        ...
        cartItems,
        { subtotal: cartSubtotal, tax: cartTax, total: cartTotal, baseTotal, discountAmount },
        'transfer'
      );
            ...
            <div className="sticky top-32 space-y-6">
              <div className="bg-purple-brand text-white rounded-[2.5rem] p-10 shadow-3xl overflow-hidden relative">
                ...
                <div className="space-y-3 pt-6 border-t border-white/20">
                    ...
                    {cartItems.map(item => (
                      <div key={item.cartId} className="flex flex-col">
                        ...
                        <div className="flex justify-between items-baseline">
                          <span className="text-xl md:text-2xl font-black">${(parseFloat(item.price) / 1.15).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  ...
                  {discountAmount > 0 && (
                    <div className="flex justify-between text-xs font-bold text-banana-yellow uppercase tracking-widest">
                      <span>Descuento</span>
