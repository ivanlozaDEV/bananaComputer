...
export async function POST(req) {
  ...
  try {
    ...
    const subject = `Tu Proforma de Banana Computer: #${quote.slug}`;
    ...
    const htmlContent = getBaseTemplate(`
      ...
      <p>Puedes revisar el detalle completo de los equipos y realizar tu pago en línea haciendo clic en el siguiente botón:</p>
      
      <div style="text-align: center; margin: 35px 0;">
        <a href="${quoteUrl}" style="background: #4B467B; color: white; padding: 16px 32px; text-decoration: none; border-radius: 12px; font-weight: bold; font-size: 16px; display: inline-block;">VER PROFORMA Y PAGAR</a>
      </div>
