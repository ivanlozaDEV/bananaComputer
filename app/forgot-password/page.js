    ...
    <div className="min-h-screen bg-cream-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] bg-white rounded-[2rem] p-8 shadow-3xl border border-black/5 relative z-10 animate-in fade-in zoom-in-95 duration-500">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-black tracking-tight text-center">Recuperar Acceso</h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          {message ? (
            <div className="p-6 bg-mint-success/5 border border-mint-success/10 rounded-2xl flex flex-col items-center text-center gap-2 animate-in fade-in slide-in-from-bottom-2">
              ...
              <p className="text-[10px] font-bold text-mint-success leading-relaxed uppercase tracking-widest">{message}</p>
            </div>
          ) : (
            <button 
              type="submit" 
              className="w-full py-3.5 bg-purple-brand text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:scale-102 active:scale-95 transition-all shadow-xl shadow-purple-brand/20 disabled:opacity-50 flex items-center justify-center gap-3"
              disabled={loading}
            >
